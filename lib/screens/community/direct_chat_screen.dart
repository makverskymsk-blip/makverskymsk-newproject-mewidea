...
/// Direct message screen for 1-on-1 chat between mutual friends.
...
class _DirectChatScreenState extends State<DirectChatScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (myUid != null) {
        final chatId =
            SupabaseService.getDirectChatId(myUid, widget.targetUserId);
        _chatProv.openChat(
              chatId: chatId,
              chatType: 'direct',
              myUserId: myUid,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            _avatar(widget.targetUserName, widget.targetUserAvatar, 32),
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Напишите ${widget.targetUserName}',
                                style: TextStyle(
  ...
  Widget _messageBubble(ChatMessage msg, String myUid, dynamic t) {
